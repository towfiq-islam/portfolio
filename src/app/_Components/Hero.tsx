        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="space-y-2.5 md:space-y-4 xl:space-y-5.5 2xl:space-y-6">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 pt-2 md:pt-0">
              <motion.a
                ...
                href="https://drive.google.com/file/d/1YhnYv-8jDvj3_Hl0zuA2a-hHuU0yz_xu/view?usp=drivesdk"
                target="_blank"
          ...
          <div className="flex justify-center relative">
            ...
            >
              ...
              <motion.div
                className="bg-blue-700/15 shadow-sm shadow-secondary rounded-full px-2 xl:px-3 py-1 absolute -bottom-5 md:bottom-0 -right-3 md:-right-10  text-sm xl:text-base"
                animate={{ y: [0, -10, 0] }}
                transition={{
                  duration: 2,
                  repeat: Infinity,
              ...
              <motion.div
                className="bg-blue-700/15 shadow-sm shadow-secondary rounded-full px-2 xl:px-3 py-1 absolute top-20 -right-10 xl:-right-20 text-sm xl:text-base hidden md:block"
                animate={{ y: [0, -10, 0] }}
                transition={{
                  duration: 2,
                  repeat: Infinity,
